...
const afterSalesTax = orders.map(order => order.price + (order.price * order.tax))
...
const bobsTotal = purchases.filter(purchase => purchase.owner === "Bob").reduce((a, b) => a + b.price, 0)
